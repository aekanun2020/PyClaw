...
### ⚠️ ขอบเขตและการตัดสินใจ
- **ตัดสินใจใช้ Qwen3.6 เป็นโมเดลหลักของ benchmark** — ชุด **Sonnet หยุดเก็บไว้ที่ 1 รอบ (R1) — ไม่เก็บต่อ** (R1 คงไว้เป็นจุดอ้างอิง Sonnet เท่านั้น); ข้อสรุป compliance-instability อ้างอิงชุด Qwen3.6 5 รอบเต็มเป็นหลัก
...
|---|:---:|:---:|:---:|
| Sonnet | R1 (1 รอบ) | ⏹️ หยุดเก็บที่ 1 รอบ — ไม่เก็บต่อ (ตัดสินใจ 22 มิ.ย.) | 1/1 (R1 ผ่าน) |
| Qwen3.6 | R2–R6 (5 รอบ) | ✅ **โมเดลหลักของ benchmark** — ครบตาม spec | **2/5 (40%)** |
